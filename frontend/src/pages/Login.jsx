...
export default function Login({ onContinue, goSignup }) {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="w-full max-w-[360px] rounded-[2rem] border border-white/55 bg-[linear-gradient(150deg,rgba(255,255,255,0.88),rgba(250,252,255,0.56))] px-5 py-6 shadow-[0_18px_40px_rgba(36,44,57,0.16)] backdrop-blur-[5px] md:max-w-[440px] md:px-7 md:py-7"
        ...
        >
          ...
          <motion.button
            ...
            className="group relative mt-5 h-[58px] w-full overflow-hidden rounded-[1rem] border border-[#283447] bg-[linear-gradient(160deg,#1f2c40,#131a26)] px-5 text-[1.45rem] font-extrabold leading-none tracking-tight text-white shadow-[0_10px_24px_rgba(16,26,43,0.35)] disabled:cursor-not-allowed disabled:opacity-60"
            style={{ fontFamily: "'Space Grotesk', 'Sora', sans-serif" }}
          >
