...
export default function Signup({ onContinue, goLogin }) {
  ...
  return (
    <div className="min-h-screen bg-[#ececed] px-4 py-6">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-[360px] flex-col items-center justify-center pb-8">
        ...
        <div className="w-full max-w-[270px] rounded-[1.2rem] bg-[#202126] p-4 text-white shadow-[0_12px_26px_rgba(15,23,42,0.24)]">
          <h2 className="mb-4 text-center text-4xl font-extrabold leading-[0.95] tracking-tight">
            Sign
            <br />
            Up
          </h2>
          ...
          <p onClick={goLogin} className="mt-3 cursor-pointer text-center text-xs text-white/80">
