  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto rounded-[1rem] border border-[#a3b3cb] bg-[rgba(255,255,255,0.46)] px-3 py-3 shadow-[0_8px_20px_rgba(31,43,64,0.12)] backdrop-blur-[2px]">
